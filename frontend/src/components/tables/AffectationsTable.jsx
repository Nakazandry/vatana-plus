    ...
    <div className="overflow-x-auto bg-white">
      <table className="w-full min-w-[880px] border-separate border-spacing-0">
        <thead className="sticky top-0 z-[1] text-left text-xs font-bold uppercase tracking-wide text-slate-500">
          <tr>
            <th className="border-b border-gray-200 bg-gray-50 px-5 py-4">Sportif</th>
            ...
            <th className="border-b border-gray-200 bg-gray-50 px-5 py-4">Date</th>
          ...
          {chargement ? (
            <tr>
              <td colSpan="6" className="px-5 py-10 text-center text-gray-500">
                ...
                <p className="mt-4 font-medium">Chargement des affectations...</p>
              </td>
            </tr>
            ...
            <tr>
              <td colSpan="6" className="px-5 py-12 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Affectez un programme à un sportif.
                </p>
              </td>
            </tr>
          ) : (
            affectations.map((a) => (
              <tr key={a.id} className="group transition hover:bg-green-50/40">
                <td className="border-b border-gray-100 px-5 py-4">
                  <p className="font-semibold text-slate-950">
                    {a.nom} {a.prenom}
                  </p>
                  <p className="text-sm text-gray-500">ID #{a.utilisateur_id}</p>
                </td>
                ...
                <td className="border-b border-gray-100 px-5 py-4 text-sm font-medium text-gray-600">
                  {a.date_affectation
                    ? new Date(a.date_affectation).toLocaleDateString()
                    : "-"}
                </td>
